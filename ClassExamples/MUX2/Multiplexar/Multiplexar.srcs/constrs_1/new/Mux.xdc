...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { in[2] }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { out }]; #IO_L10P_T1_D14_14 Sch=led16_g
