...
HD_PWD='/home/tirth/Classes/ECE3300/ClassExamples/BCD/BCD_Driver/BCD_Driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsp_driver.tcl -notrace
