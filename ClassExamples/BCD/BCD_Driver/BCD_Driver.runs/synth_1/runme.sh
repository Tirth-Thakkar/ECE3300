...
HD_PWD='/home/tirth/Classes/ECE3300/ClassExamples/BCD/BCD_Driver/BCD_Driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_driver.tcl
