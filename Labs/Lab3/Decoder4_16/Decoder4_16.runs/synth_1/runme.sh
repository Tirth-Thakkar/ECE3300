...
HD_PWD='/home/tirth/Classes/ECE3300/Labs/Lab3/Decoder4_16/Decoder4_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder4_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder4_16.tcl
